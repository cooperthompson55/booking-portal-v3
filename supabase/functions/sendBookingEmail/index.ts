...
// Add version logging
console.log("Function version: 1.0.8");
...
• Preferred Date: ${new Date(preferred_date).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
• Address: ${addressStr}
